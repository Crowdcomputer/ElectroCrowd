...
(function($) {'$:nomunge';// Used by YUI compressor.
...
function CM_result(message_in_JSON) {
	...
	var url='http://'+gup('parent');
        $.postMessage((message_in_JSON), url, parent);
}
function CM_result_parent(message_in_JSON,parent_url) {
	$.postMessage((message_in_JSON), parent_url, parent);
}
...
$(document).ready(function() {
	/* $('[type=submit]').(function(){
	 ...
	 $(document).on("click", this, linkLoc)
